...
@pytest.mark.parametrize(
    ["line", "expected"], [("abba[mnop]qrst", True), ("abcd[bddb]xyyx", False), ("aaaa[qwer]tyui", False), ("ioxxoj[asdfgh]zxcvbn", True)]
)
...
@pytest.mark.parametrize(
    ["line", "expected"], [("aba[bab]xyz", True), ("xyx[xyx]xyx", False), ("aaa[kek]eke", True), ("zazbz[bzb]cdb", True)]
)
