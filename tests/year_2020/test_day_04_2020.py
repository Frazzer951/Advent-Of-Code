import pytest
from adventofcode.year_2020.day_04_2020 import part_one, part_two, parse_passports, verify_passport_1, verify_passport_2
...
def test_parse_passports():
    ...
    assert (
        passports[3] == "hcl:#cfa07d eyr:2025 pid:166559648 iyr:2011 ecl:brn hgt:59in "
    )
